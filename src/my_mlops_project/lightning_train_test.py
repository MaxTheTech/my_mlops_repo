    ...
    def on_train_batch_end(self, trainer, pl_module, outputs, batch, batch_idx):
        ...
        if batch_idx % 100 == 0:
            ...
            trainer.logger.experiment.log({
                "images": wandb.Image(samples.cpu(), caption="Input images")
            })
...
def train(cfg) -> None:
    ...
    train_set, val_set = torch.utils.data.random_split(train_val_set, [train_size, val_size], generator=torch.Generator().manual_seed(cfg.training.seed))
